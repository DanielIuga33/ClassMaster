...
class GroupAddUi(tk.Toplevel):
    def __init__(self, parent, theme, user_id, group_service: GroupService, student_service: StudentService,
        ...
        # Titlu - Folosim nuanța de mov (accent) dar cu fundal din temă
        ...
        for label_text, key in fields:
            ...
            # REPARARE FUNDAL: Folosim input_bg pentru contrast
        ...
        tk.Label(self, text="Selectează Studenții (doar cei nealocați):", bg=theme["bg"], fg=self.txt_color,
        ...
        # REPARARE LISTBOX: Forțăm culorile de contrast
        ...
        # Buton Salvare - Folosim nuanța de mov pentru acest modal
